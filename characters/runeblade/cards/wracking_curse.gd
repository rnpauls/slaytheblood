## Pure debuff stacker: pile Marked AND Exposed on a single target so any attack
## landed against them this turn hits about 2× harder. No damage of its own —
## pairs with a follow-up swing or runic detonation.
extends Card
